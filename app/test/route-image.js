var route = require('../routes/image')
  , fs = require('fs')
  , path = require('path');
...
var userId = '';
...
exports['jpg test image upload'] = function(t) {
  ...
  route(
    { post: function(path, handler) {
        ...
        handler({ body: { userId: userId, token: token, files: { image: 'asd'}}}, { json: function(res) { t.deepEqual(res, { ok: 'ok', data: imgId }) } });
      }
    },
    cfg,
